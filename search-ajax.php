...
?>
    ...
    <!-- Assigning searched result in "Search box" in "planning.php" file. -->
                <?php echo "<li class='addCourse list-group-item list-group-item-action' data-courseid='" . $Result['courseID'] . "' data-coursename='" . $Result['courseName'] . "'>" . $Result['courseName'] . "</li>";
                ?>
        <?php
            }}
        ?>