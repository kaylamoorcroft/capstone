...
('', 0, 'COMP 1113 Laboratory', 'COMP', '1110L', 'NULL', 'FA,WI,COI', 7653),
('Introduction to the field of computer science and computer programming. Topics include fundamental programming constructs, algorithms, and problem-solving. Lecture and lab. No programming experience required. Prerequisite(s): Mathematics 12 (or equivalent) or Precalculus 12 (or equivalent) or 3h of Mathematics. Antirequisite(s): Credit can be obtained for only one of COMP 1113 or COMP 1893.', 3, 'Computer Programming 1', 'COMP', '1113', 'NULL', 'FA,WI,COI', 7654),
('', 0, 'COMP 1123 Laboratory', 'COMP', '1120L', 'NULL', 'FA,WI,SU', 7655),
...
('', 0, 'COMP 2103 Laboratory', 'COMP', '2100L', 'NULL', 'WI', 7684),
...
('Topics include introduction to abstract data specification, implementation and testing, introduction to algorithms and their analysis. Prerequisite(s): COMP 1123 and either (MATH 1323 or MATH 1333), each with a minimum grade of C-.', 3, 'Data Structures and Algorithms', 'COMP', '2113', 'NULL', 'FA', 7686),
('', 0, 'COMP 2203 Laboratory', 'COMP', '2200L', 'NULL', 'FA,COI', 7690),
('Topics include digital logic and digital systems, machine level representation of data, assembly level organization and architecture. (1.5h lab). Prerequisite(s): 6h of mathematics cross-coded as APSC 2223.', 3, 'Comp Architect./Organization 1', 'COMP', '2203', 'NULL', 'FA,COI', 7691),
...
('Topics include the technical, economic, legal, political, social, ethical, and professional issues related to the widespread use of computers. Prerequisite(s): 3h COMP with a minimum grade of C-.', 3, 'Computers and Society', 'COMP', '2903', 'NULL', 'FA,WI', 7718),
...
('Introduction to the tools and techniques of information systems analysis and design and the project management process. The analysis and specification of systems requirements will be covered, as well as the design of system data, input, output and processes. A typical business case study project will constitute a major portion of the course. Prerequisite(s): COMP 1113, COMP 1893 or COMP 2863 with a minimum grade of C-, or permission of the School of Computer Science.', 3, 'Systems Analysis and Design', 'COMP', '3513', 'NULL', 'WI', 7740),
('Selected higher-level concepts in computer graphics, such as display devices, display files and data structures for graphics, interactive and dynamic display techniques, three-dimensional graphics, shaded and colour graphics. Graphics language standardization, and device-independent software. Prerequisite(s): COMP 2113, MATH 1013, MATH 1413, and MATH 1323, each with a minimum grade of C-.', 3, 'Computer Graphics', 'COMP', '3553', 'NULL', 'FA', 7744),
('Examines the human factors associated with information technology and seeks to provide students with knowledge of the variables likely to influence the perceived usability, and hence the acceptability, of any information technology. This course introduces a series of techniques for developing and evaluating usable software, with a focus on both mobile and traditional computing hardware. Prerequisite(s): COMP 2113.', 3, 'Human Computer Interaction', 'COMP', '3583', 'NULL', 'FA', 7745),
('', 0, 'COMP 3613 Laboratory', 'COMP', '3610L', 'NULL', 'FA', 7746),
...
('Basic components and techniques of translators for programming languages; preprocessors, compilers, interpreters, assemblers. Prerequisite(s): COMP 2103, COMP 2113, MATH 1413, (MATH 1323 or MATH 1333), each with a minimum grade of C-.', 3, 'Translators', 'COMP', '3703', 'NULL', 'WI', 7750),
...
('This course provides an introduction to research methods in computer science.', 3, 'Research in Computer Science', 'COMP', '5923', 'NULL', 'FA', 7810),
('', 0, 'Thesis', 'COMP', '5960', 'NULL', 'NULL', 7811),
('Topics from high school mathematics. This non-credit course serves as a prerequisite for courses that require NS Mathematics 11 and 12 or their equivalent. Prerequisite(s): Permission of the instructor.', 0, 'Pre-University Mathematics', 'MATH', '0110', 'NULL', 'COI', 9938),
...
('Further topics in probability including independence and conditional probability, Binomial and Poisson distributions; estimation, confidence intervals and hypothesis testing for (i) proportions in one and two populations, (ii) means in one and two populations, (iii) linear regression models, (iv) goodness of fit and contingency tables (v) other statistical models. Science applications will be used throughout the course.', 3, 'Statistics II for Science', 'MATH', '2253', 'NULL', 'SU', 9992),
...
('Descriptive statistics and exploratory data analysis, including correlation and the least squares regression line; basic probability including random variables and normal distribution; sampling distributions; introduction to estimation, confidence intervals and hypothesis testing; one-way analysis of variance. Prerequisite(s): Mathematics 11 and 12, or Precalculus 11 and 12, or MATH 1003. Antirequisite(s): MATH 1213, MATH 2233, ECON 2613. Students who have completed Math 2213 may not subsequently receive credit for this course.', 3, 'Statistics 1', 'MATH', '1253', 'NULL', 'SU', 13370),
...
('Introduction to both procedural and object-oriented programming for those students with previous programming experience. Topics include control statements, functions and algorithms, problem-solving, inheritance, polymorphism, recursion, and file processing. Lecture and Lab. Credit can be obtained for only one of COMP 1113 and COMP 1233; however, students who have taken COMP 1113 and subsequently take COMP 1233 may count COMP 1113 as a Computer Science elective.', 3, 'Introd to Computer Science', 'COMP', '1233', 'NULL', 'FA', 13571),
('Introduction to computer concepts for programmers. Topics include the command line environment, shell programming, version control, debugging, text editors, word processing, spreadsheets, file management, data handling, and cloud-based environments. Prerequisite(s): COMP-1113 or COMP-1233', 3, 'Computer Concepts for Program', 'COMP', '1243', 'NULL', 'WI', 13572),
('Theory and hands-on experience with the Internet and Web infrastructure, E-commerce and M-commerce  concepts, both client-side and server-side software technologies, database, E-payment, security and authentication, CSS, XML, and mobile data access and Web standards. Prerequisite(s): COMP 1123 or COMP 1233 with a minimum grade of C-. Antirequisite(s): Credit can be obtained for only one of COMP 3033 or COMP 2513.', 3, 'Full-Stack Cloud Computing', 'COMP', '3033', 'NULL', 'WI', 13573),
