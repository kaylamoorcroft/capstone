...
('COMM 1213 is an introductory course designed to help students develop the skills necessary for effective communication in the workplace and other professional environments. Communication concepts are introduced to provide a foundation for the work and students learn appropriate strategies, approaches, and formats for writing various business/professional documents. Presentation techniques and collaborative communication methods are also discussed and practiced. Prerequisite(s): Open to Business students only (or with instructor permission.) Antirequisite(s): Credit can be obtained for only one of COMM 1213, COMM 1013, or CODE 1043.', 3, 'Business Communication 1', 'COMM', '1213', 'NULL', 'NULL', 7647),
...
('Topics include software requirements and specifications, methods and tools for object-oriented analysis and design, introduction to software validation, introduction to design patterns and frameworks, programming with components, using APIs, software tools and environments, software processes (introduction), software evolution (introduction), software project management. Prerequisite(s): COMP 1123 with a minimum grade of C-.', 3, 'Software Engineering 1', 'COMP', '2663', 'NULL', 'FA', 7707),
...
('The game development life cycle, game design and programming, graphics engines and game engines, game tools. Prerequisite(s): COMP 3553 and 3773, each with a minimum grade of C-.', 3, 'Game Development', 'COMP', '4553', 'NULL', 'WI', 7771),
...
('Special topics in artificial intelligence. Prerequisite(s): COMP 3613 with a minimum grade of C-, and permission of the School of Computer Science.', 3, 'Artificial Intelligence 2', 'COMP', '4613', 'NULL', 'WI', 7774),
...
('An introductory survey of psychology with emphasis on basic processes, including perception, learning, biological bases of behaviour, cognition, and basic research methods. Antirequisite(s): Credit can be obtained for only one of PSYC 1013 or PSYC 1113.', 3, 'Introductory Psychology 1', 'PSYC', '1013', 'NULL', 'NULL', 11315),
('An introductory survey of psychology with emphasis on social psychology, developmental psychology, abnormal behaviour, psychotherapy, personality and assessment. Prerequisite(s): PSYC 1013. Antirequisite(s): Credit can be obtained for only one of PSYC 1023 or PSYC 1123.', 3, 'Introductory Psychology 2', 'PSYC', '1023', NULL, 'WI,COI', 11317),
('Section Restrictions - 01 and 03 for PSYC majors , 02 and 04 for non-PSYC majors. This course is an introduction to the study of mental processes used in learning, remembering, thinking, language, creativity, decision-making and problem solving. Emphasis will be placed on theories and the research methods used by cognitive psychologists. Prerequisite(s): PSYC 1013 or PSYC 1113.', 3, 'Introduction to Cognition', 'PSYC', '2143', 'NULL', 'NULL', 11339),
...
CREATE TABLE `meetings` (
  `EndTime` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Days` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `StartTime` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Frequency` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `IsOnline` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
('2026-04-09T17:20:00+00:00', '1,3', '2026-04-09T16:00:00+00:00', 'W', 'false', 3, 21628),
('2026-03-16T16:50:00+00:00', '4', '2026-03-16T16:00:00+00:00', 'W', 'false', 4, 20504),
('2026-04-09T17:20:00+00:00', '1,3', '2026-04-09T16:00:00+00:00', 'W', 'false', 5, 21629),
('2026-03-16T14:20:00+00:00', '5', '2026-03-16T13:30:00+00:00', 'W', 'false', 6, 20505),
('2026-04-09T18:50:00+00:00', '1,3', '2026-04-09T17:30:00+00:00', 'W', 'false', 7, 21630),
('2026-03-16T15:20:00+00:00', '2,4', '2026-03-16T14:00:00+00:00', 'W', 'false', 8, 20508),
('2026-04-09T18:50:00+00:00', '1,3', '2026-04-09T17:30:00+00:00', 'W', 'false', 9, 21631),
...
('NULL', '', 'NULL', 'W', 'true', 209, 22308),
('2026-04-23T00:00:00-03:00', '1,3,5', '2026-04-09T14:30:00+00:00', 'W', 'false', 210, 21585),
('NULL', '', 'NULL', 'W', 'true', 211, 22309),
('2026-04-09T14:20:00+00:00', '1,3,5', '2026-04-09T13:30:00+00:00', 'W', 'false', 212, 21586),
('2026-04-09T15:20:00+00:00', '1,3,5', '2026-04-09T14:30:00+00:00', 'W', 'false', 213, 21587),
('NULL', '', 'NULL', 'W', 'true', 214, 22253),
('2026-04-09T17:20:00+00:00', '1,3', '2026-04-09T16:00:00+00:00', 'W', 'false', 215, 20494),
('2026-04-09T20:20:00+00:00', '1,3', '2026-04-09T19:00:00+00:00', 'W', 'false', 216, 20495),
('2026-04-09T18:50:00+00:00', '2,4', '2026-04-09T17:30:00+00:00', 'W', 'false', 217, 20496);
...
(18, 'true', 'Previous', 'PSYC-1013 OR PSYC-1113', '- Must be completed prior to taking this course.', 11339),
...
(558, 'true', 'Previous', 'PSYC-1013', '- Must be completed prior to taking this course.', 11317),
...
(19658, NULL, NULL, 'MOUB Mandatory', '', 'Complete all of the following  items.', 19657),
(19662, NULL, NULL, '3h Sci/Busi non-COMP', '3h from the Faculty of Pure and Applied Science (excluding COMP, MATH and COOP) or the School of Business Administration', 'Complete all of the following  items.', 19657),
(19664, NULL, NULL, '21h Electives', '21h electives from any subject.', 'Complete all of the following  items.', 19657),
...
(22838, NULL, '', '3h non-COMP/MATH', '3h from courses not including COMP, MATH and COOP', 'Complete all of the following  items.', 19657),
...
(24101, NULL, '', 'Specified COMP', 'Take COMP-2103 COMP-2113 COMP-2203 COMP-2213 COMP-2663     COMP-2903 COMP-3343 COMP-3613 COMP-3663 COMP-3713     COMP-3753;     Minimum grade C-,P;', 'Complete all of the following  items.', 24095),
(24103, NULL, '', 'Project', '', 'Complete all of the following  items.', 24095),
...
(24114, NULL, '', '9h Faculty of Arts', '9h from the Faculty of Arts (not ECON 2613, 2623, or SOCI 3103)', 'Complete all of the following  items.', 24095),
(24207, NULL, '', 'COMP 1113 and 1123', 'Take COMP 1113 and 1123 if you\'ve had no prior Computer Science studies.', 'Complete all of the following  items.', 24206),
(24209, NULL, '', 'COMP 1233 plus 3h', 'Take COMP 1233 and 3h additional COMP if you\'ve had prior Computer Science studies in high school.', 'Complete all of the following  items.', 24206),
...
--
ALTER TABLE `meetings`
  MODIFY `meetings_pk` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=218;
