...
<?php
    ...
    // __DIR__ creates absolute path so relative path doesn't break when run subfolder script
    // require_once prevents redeclaration errors
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <select name="semester" id="semester" class="form-control" style="background-color: rgb(172, 214, 227)" required>
                </select>
